        ...
        <section className="section">
          <div className="container grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
            ...
            <div className="lg:col-span-5 flex flex-col gap-8">
              <article className="card p-10 flex flex-col gap-8 border border-border-subtle h-full">
                <header className="flex flex-col gap-2">
                  <span className="label text-brand-800 border-b border-border-subtle pb-2 w-fit mb-2">Incentives</span>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-6 flex-grow">
                  {BENEFITS.map((b, i) => (
                    ...
                    >
                      <div className="w-11 h-11 rounded-xl bg-brand-100 flex items-center justify-center text-brand-800 flex-shrink-0 group-hover:bg-brand-900 group-hover:text-white transition-all duration-300 shadow-sm">
                        {b.icon}
                      </div>
                      <p className="text-sm text-text-700 font-bold leading-relaxed pt-1.5 m-0">
                        {b.text}
                      </p>
                    </motion.div>
                  ))}
              ...
              <article
                className="card p-10 flex flex-col gap-6 relative overflow-hidden shadow-premium border-none"
              ...
              >
                ...
                <div className="flex-grow relative z-10">
                  <p className="text-sm text-white/90 font-medium leading-relaxed m-0 line-clamp-4">
                    We are currently looking for mentors in our "Wezesha Dada"
                    program and regional youth digital skills trainers.
                  </p>
                </div>
                <footer className="relative z-10 flex items-center gap-2 text-[10px] font-black text-white uppercase tracking-[0.2em] border-t border-white/10 pt-6 mt-auto">
            ...
            <div className="lg:col-span-7">
              <form
                className="card p-10 lg:p-12 flex flex-col gap-10 border border-border-subtle h-full"
              ...
              >
                <header className="flex flex-col gap-2">
                  ...
                  <h2 className="h2 text-brand-900 uppercase tracking-tight">
                    Official{" "}
                    <span className="text-brand-600">Enlistment</span>
                  </h2>
                </header>
